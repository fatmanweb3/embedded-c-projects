...
uint32_t adc_conversion()
{
	...
	adc_value = HAL_ADC_GetValue(&hadc1); // getting adc valyu
	HAL_ADC_Stop(&hadc1); // stopping adc just an optional, makes system clear.

	return adc_value; // returning the adv calue.
}
